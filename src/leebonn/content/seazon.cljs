...
(def seazon-context
  {:fr "Créé en 2018, Seazon est un abonnement de plats fraîchement cuisinés par des chefs livrés dans toute la France. Cette formule sans engagement propose des plats équilibrés concoctés avec des produits locaux. \n\nLa marque lance en 2021 la gamme Equilibre destiné au rééquilibrage alimentaire. La philosophie de la gamme est de faire du rééquilibrage alimentaire une habitude à adopter pour se sentir mieux dans sa peau."
...
(def seazon-objective
  {:fr [c/bullet-list
        "La notoriété de l’offre Seazon Équilibre"
   ...
   :en [c/bullet-list
        "Raise awareness of the Seazon Equilibre offering."
        "Generate interest in the nutritional rebalancing approach."
        "Promote product trials to convert to a subscription."]})
...
(def seazon-recommendation
  {:fr [:span
        "Ex-miss France, désormais interne de médecine générale,  Marine Lorphelin est créatrice de contenus et chroniqueuse bien-être. Elle a 1M de followers sur Instagram. Son contenu est axé sur la nutrition et le sport.\n\n"
   ...
   :en [:span
        "Marine Lorphelin participated in the French national beauty competition “Miss France”. Now she’s a doctor, an author and a content creator around well-being, nutrition and fitness. She has 1 million followers on Instagram \n\n"
