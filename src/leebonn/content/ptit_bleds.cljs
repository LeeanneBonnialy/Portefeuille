...
(def brief
  {:fr [:b "Inventer une association qui défend une cause, en réponse à une ou plusieurs problématiques contemporaines. \n\nMettre en place une campagne de communication et de marketing directe."]
   :en [:b "Inventing an association that advocates for a cause in response to one or several contemporary issues.\n\nImplementing a communication and direct marketing campaign."]})
...
(def challenge
  {:fr [:b "En période de crise où différentes causes rivalisent, comment accroître la visibilité et encourager les dons en faveur d'une association ?"]
   :en [:b "In times of crisis where various causes compete, how do you increase visibility and encourage donations to support a specific association?"]})
...
(def objective
  {:fr "Créer une campagne de communication cohérente et impactante  à l’aide de différents leviers (réseaux sociaux, événements, relation presse...)."
...
(def steps-1
  {:fr "En Ile de France, le tourisme est trop souvent un tourisme de masse. L’attention est rivée sur la capitale et les lieux de culture prisés (Louvre, Château de Versailles, Disneyland). \n\nAutre problème identifié : pour une grande partie des Français, l’écologie est une notion de plus en plus importante à prendre en compte lorsqu’il s’agit de planifier ses voyages. \nCependant dans les faits cette prise en compte est minime dans les choix faits par les touristes."
   :en "In the parisian region of Île-de-France, tourism often takes the form of mass tourism, with a focus on the capital and popular cultural sites such as the Louvre, Palace of Versailles, and Disneyland.\n\nAnother identified issue: for a lot of French people, ecology is an increasingly important consideration when they plan trips. However, in practice, this consideration has less impact on the choices made by tourists."})


(def steps-quote
  {:fr [:span "La réponse au tourisme de masse = le " [:b "tourisme de proximité.\n" [:s "Voyager loin,"] " Voyager mieux"]]
   :en [:span "The solution to mass tourism = " [:b "local tourism.\n" [:s "Travel far,"] " Travel Better."]]})
...
(def recommendation-2
  {:fr "Pour ce qui est de la notoriété, les cibles sont les médias traditionnels locaux et nationaux orientés culture et/ou écologie."
   :en "To increase the association’s visibility, the targets are local and national traditional media outlets focused on culture and/or ecology."})
...
(def recommendation-5
  {:fr "Le plan média se compose d’un lancement d’un communiqué de presse associé à l’organisation d’un gala."
...
(defn project-detail
  ...
  [:div.space-y-4.text-pink-400.leading-relaxed
   ...
   [c/inline-img "ptit-bleds/body_2.jpg"]

   [c/header recommendation-header]
   [c/body recommendation-1]
   [c/inline-img "ptit-bleds/body_3.jpg"]
   [c/inline-img "ptit-bleds/body_4.jpg"]
   [c/body recommendation-2]
   [c/inline-img "ptit-bleds/body_5.jpg"]
   [c/body recommendation-3]
   [c/inline-img "ptit-bleds/body_6.jpg"]
   [c/inline-img "ptit-bleds/body_7.jpg"]
   [c/inline-img "ptit-bleds/body_8.jpg"]
   [c/inline-img "ptit-bleds/body_9.jpg"]
   [c/inline-img "ptit-bleds/body_10.jpg"]
   [c/body recommendation-4]
   [c/inline-img "ptit-bleds/body_11.jpg"]
   [c/body recommendation-5]
   [c/inline-img "ptit-bleds/body_12.jpg"]
   [c/download {:en "Download the presentation"
                :fr "Téléchargez la présentation"}
    "assets/ptit-bleds/PTIT_BLEDS.pdf"]
   [c/page-end-buffer]])
