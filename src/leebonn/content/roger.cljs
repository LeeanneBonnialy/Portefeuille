...
(def comp-3
  {:fr "Réalisation de briefs créatifs"
   :en "Making creative briefs"})


(def comp-4
  {:fr "Réalisation de calendriers éditoriaux"
   :en "Making editorial calendars"})


(def comp-5
  {:fr "Social listening Visibrain"
...
(def brief
  {:fr [:b "Accompagner Rogervoice dans sa stratégie social média, la gestion des réseaux sociaux et la création de nouveaux formats pour le lancement de sa nouvelle marque."]
   :en [:b "Support Rogervoice in its social media strategy, social network management, and the creation of new formats for the launch of its new brand."]})
...
(def context
  {:fr "Rogervoice est une application de téléphonie créée en 2014. Elle permet aux personnes qui ont des troubles de l’audition de téléphoner au moyen de la reconnaissance vocale et à la transcription en direct. \n\nSon ambition est de se positionner comme un service incontournable pour toutes les personnes qui ont des difficultés à entendre et leurs proches. Rogervoice s’est créée dans la volonté de dépoussiérer le monde de la surdité.  En ce sens, la marque a opéré un changement d’identité."
   :en "Rogervoice is a telephony application created in 2014. It enables individuals with hearing impairments to make phone calls using voice recognition and live transcription. \n\nIts ambition is to establish itself as an essential service for individuals facing hearing challenges and their loved ones. Rogervoice was born out of the desire to modernize the world of hearing impairment because hearing impairment is often reduced to a disability.  In this regard, the brand has undergone a radical identity change."})
...
(def challenge
  {:fr [:b "Incarner la vision et la nouvelle identité de Rogervoice sur ses réseaux sociaux afin de toucher les sourds/malentendants, leurs proches et les professionnels du secteur."]
   :en [:b "Embody the vision and new identity of Rogervoice on its social media platforms to reach the deaf/hearing-impaired community, their loved ones, and professionals in the sector."]})
...
(def recommendation-header
  {:fr "Réponse stratégique : Création de nouveaux formats et travail du ton de voix"
   :en "Strategic recommendation : create new editorial formats on social media and work on the tone of voice"})
